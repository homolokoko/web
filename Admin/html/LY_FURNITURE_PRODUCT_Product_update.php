    ...
    <?php
        if(isset($_POST['Update']))
        {
            ...
            if($fnm=="")
            {
                ...
                {
                    mysqli_query($conn,"UPDATE `ly_furniture_product` SET TITLE='$_POST[Title]', QTY='$_POST[Qty]', PRICE='$_POST[Price]', DISCOUNT='$_POST[Discount]', WIDTH='$_POST[Width]', HEIGHT='$_POST[Height]' WHERE ID=$id ");
                    ?>
                        <script>
             ...
             }else
            {
                ...
                mysqli_query($conn,"UPDATE `ly_furniture_product` SET  TITLE='$_POST[Title]', QTY='$_POST[Qty]', PRICE='$_POST[Price]', DISCOUNT='$_POST[Discount]', WIDTH='$_POST[Width]', HEIGHT='$_POST[Height]',IMAGE='$dst1' WHERE ID=$id ");
                ?>
                    <script>
                        window.location.href = "./LY_FURNITURE_PRODUCT_Product_table.php";
                    </script>
