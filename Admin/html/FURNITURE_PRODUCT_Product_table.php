  ...
  <div class="main_container_table">
    <div class="myheader">
      <div class="contain_header">
        ...
        <a class="btnAdd" href="./FURNITURE_PRODUCT_Insert_product.php">ADD MORE</a>
      </div>
    </div>
    <div class="mytable">
              ...
              while($row = mysqli_fetch_assoc($result))
              {
                  ...
                  echo '
                      <tr>
                          ...
                          <td>
                              <a href="./FURNITURE_PRODUCT_Product_update.php?id='.$id.' " class="btnView">View</a>
                              <a href="../Controller/FURNITURE_PRODUCT_Body_Delete_method.php?id='.$id.' " onclick="return confirmDelete()" class="btnDelete">Delete</a>
                          </td>
                      </tr>
                      ' ;
              };
